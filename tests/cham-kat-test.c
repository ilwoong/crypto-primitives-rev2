...
static const kat_block_cipher_entry ENTRIES[] = {
    {"cham64_128", &cham64_128_block_cipher, 16, 8, &ctx_cham},
    {"cham128_128", &cham128_128_block_cipher, 16, 16, &ctx_cham},
    {"cham128_256", &cham128_256_block_cipher, 32, 16, &ctx_cham},
};
