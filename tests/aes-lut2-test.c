...
int main(void)
{
    ...
    failures += run_test_vector(&aes128_lut2_block_cipher, &TV_AES128);
    failures += run_test_vector(&aes192_lut2_block_cipher, &TV_AES192);
    failures += run_test_vector(&aes256_lut2_block_cipher, &TV_AES256);
